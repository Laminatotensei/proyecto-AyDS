    ...
    <div class="container">
        ...
        <?php
            ...
            try {
                ...
                $sql = "SELECT ID_CLIENTE, MODELO, FALLAS FROM CARROS WHERE ID = :id";
                ...
                echo
                "<form action='IBM_Carros_Listo_SQL.php' method='post'>
                        ...
                        <div class='card'>  
                            ...
                            <div class='row pl-2 pr-2'>";
                                ...
                                if ($vueltas != 0) {
                                    ...
                                    "<div class='col-lg-6 col-md-12 col-12'>
                                        <div class='form-group'>
                                            <td><input type='text' value=' TOTAL ' name='TbTotalTexto' class='form-control' placeholder='TOTAL' readonly></td>
                                        </div>
                                    </div>
                                    <div class='col-lg-6 col-md-12 col-12'>
                                        <div class='form-group'>
                                            <td><input type='text' value='$ " . $total . ".00' name='TbTotalPrecio' class='form-control' placeholder='TOTAL PRECIO' readonly></td>
                                        </div>
                                    </div>";
                                ...
                                "<div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        <td><input type='text' value=' MANO DE OBRA ' name='TbTotalTexto' class='form-control' placeholder='Nombre del cliente' readonly></td>
                                    </div>
                                </div>
                                <div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        <td><input type='text' name='TbManoDeObra' class='form-control' placeholder='Cobro por mano de obra' required></td>
                                    </div>
                                </div>";
                            ...
                            <div class='card-footer text-muted'>
                                <td><input type='submit' value=' TERMINAR ' id='BtnLstPiezas' class='btn btn-md btn btn-primary  fa fa-check-square pr-3'></td>
