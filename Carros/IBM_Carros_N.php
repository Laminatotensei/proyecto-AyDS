...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            echo
            "<form id='PnlCampturaDatos' action='IBM_Carros_N_SQL.php' method='post'>
                        ...
                        <div class='row pl-2 pr-2'>
                            ...
                            <div class='col-12'>
                                <div class='form-group'>
                                    ...
                                    <td><input type='text' name='TbModelo' class='form-control' placeholder='Modelo del carro'></td>
                                </div>
                            </div>
                        ...
                        <div class='row pl-2 pr-2'>
                            ...
                            <div class='col-12'>
                                <div class='form-group'>
                                    ...
                                    <td><input type='text' name='TbFallas' class='form-comentario' placeholder='Defina las fallas del carro'></td>
                                </div>
                            </div>

                        </div>

                        <td><input type='text' class='oculta' value='" . $id_cliente . "' placeholder='id' name='id' id='id' readonly></td>
