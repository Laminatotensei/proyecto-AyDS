    ...
    <div class="container">
        ...
        <?php
            ...
            try {
                ...
                echo
                "<form id='PnlEditarDatos' action='IBM_Clientes_B_SQL.php' method='post'>
                    ...
                    <div class='container'>
                        ...
                        <div class='card'>
                            ...
                            <div class='card-header text-center'>
                                <h5 class='card-title'> ¿Seguro que desea borrar al siguiente cliente de sus registros? </h5>
                            </div>
                        ...
                        <div class='card-footer text-muted'>
                            ...
                            <td><input type='submit' name='Editar' value=' Borrar' class='btn btn-md btn btn-danger fa fa-minus-square pr-3'></td>
