    ...
    <div class="container">
        ...
        <?php
            ...
            try {
                ...
                echo
                "<form id='PnlEditarDatos' action='IBM_Clientes_E_SQL.php' method='post'>
                            ...
                            <div class='row pl-2 pr-2'>
                                ...
                                <div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['NOMBRE'] . "' type='text' name='TbNombreCliente' class='form-control' placeholder='Nombre del cliente' required></td>
                                    </div>
                                </div>
                                ...
                                <div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['APELLIDO'] . "' type='text' name='TbApellidoCliente' class='form-control' placeholder='Apellido del cliente'></td>
                                    </div>
                                </div>
                            ...
                            <div class='row pl-2 pr-2'>
                                ...
                                <div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['CELULAR'] . "' type='text' name='TbCelularCliente' class='form-control' placeholder='Telefono celular del cliente' required></td>
                                    </div>
                                </div>
                                ...
                                <div class='col-lg-6 col-md-12 col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['TELEFONO'] . "' type='text' name='TbTelefonoCliente' class='form-control' placeholder='Telefono de la empresa'></td>
                                    </div>
                                </div>
                            ...
                            <div class='row pl-2 pr-2'>
                                ...
                                <div class='col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['EMAIL'] . "' type='text' name='TbEmailCliente' class='form-control' placeholder='Correo electronico'></td>
                                    </div>
                                </div>
                            ...
                            <div class='row pl-2 pr-2'>
                                ...
                                <div class='col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['EMPRESA'] . "' type='text' name='TbNombreEmpresa' class='form-control' placeholder='Nombre de la empresa'></td>
                                    </div>
                                </div>
                            ...
                            <div class='row pl-2 pr-2'>
                                ...
                                <div class='col-12'>
                                    <div class='form-group'>
                                        ...
                                        <td><input value='" . $registro['RFC'] . "' type='text' name='TbRFCEmpresa' class='form-control' placeholder='RFC de la empresa'></td>
                                    </div>
                                </div>
